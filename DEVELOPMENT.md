...
```bash
git remote add encore encore://ecommerce-saas-platform-bufi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ecommerce-saas-platform-bufi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ecommerce-saas-platform-bufi/settings/integrations/github)
